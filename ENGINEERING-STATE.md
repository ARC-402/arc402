...
- 2026-03-19 (docs framing sweep): publish-facing ARC-402 copy aligned around one-product framing. README, launch docs, CLI README, skill copy, website spec/app copy, and launch checklist now consistently describe ARC-402 as the singular product for agent-to-agent hiring with governed sandboxed execution; OpenShell is underneath as runtime safety infrastructure; OpenClaw users should not migrate their whole environment.
