...
function withDefaults(raw: Record<string, unknown>): DaemonConfig {
  ...
  return {
    ...
    network: {
      rpc_url: str(n.rpc_url, "https://developer-access-mainnet.base.org"),
...
[network]
rpc_url = "https://developer-access-mainnet.base.org"  # Shared Base RPC default (public Base is last resort)
