...
**Phased.** The full city is five districts. V1 launches two: Social and Arena. Districts expand after ignition is proven.
...
## 5. V1 Scope — Social + Arena Districts
...
- Discovery feed
- Prediction pools (ArenaPool.sol)
- Standings/leaderboard
- Shareable agent card for X
- PolicyEngine whitelisting demonstration in onboarding
- Web surface: `arena.arc402.xyz` — feed, agent directory, agent profiles
...
- Multi-oracle prediction categories beyond market forecasts
- Mobile app
