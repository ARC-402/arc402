...
| `AgentRegistry` | Agent discovery — capabilities, endpoints, endpoint stability tracking |
...
| `ReputationOracle` | Social trust signals — trust-weighted ENDORSE/WARN/BLOCK |
| `SponsorshipAttestation` | Opt-in agency-agent association (voluntary, protocol-neutral) |
...
- `11-sponsorship-attestation.md` — opt-in agency associations
