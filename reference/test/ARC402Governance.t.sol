...
contract ARC402GovernanceTest is Test {
    ...
    TrustRegistryV2 trustRegistryV2;
    ...
    function setUp() public {
        ...
        trustRegistryV2 = new TrustRegistryV2(address(0));
    ...
    function test_MultisigExecutesProtocolParameterUpdate() public {
        bytes memory callData = abi.encodeWithSelector(TrustRegistryV2.setMinimumAgreementValue.selector, 5 ether);
    ...
    function test_RevertExecuteWithoutThreshold() public {
        bytes memory callData = abi.encodeWithSelector(TrustRegistryV2.setMinimumAgreementValue.selector, 1 ether);
