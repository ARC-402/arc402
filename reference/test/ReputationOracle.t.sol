...
contract ReputationOracleTest is Test {
    ...
    function setUp() public {
        ...
        trustRegistry.recordSuccess(publisher, address(0xA11), "legacy", 1 ether, block.timestamp);
        trustRegistry.recordSuccess(publisher, address(0xA11), "legacy", 1 ether, block.timestamp);
    }
    ...
    function test_WeightedScoreNetOut() public {
        ...
        trustRegistry.recordSuccess(endorser, address(0xA12), "legacy", 1 ether, block.timestamp);
        trustRegistry.recordSuccess(warner, address(0xA13), "legacy", 1 ether, block.timestamp);
        trustRegistry.recordSuccess(warner, address(0xA13), "legacy", 1 ether, block.timestamp);
        trustRegistry.recordSuccess(warner, address(0xA13), "legacy", 1 ether, block.timestamp);
