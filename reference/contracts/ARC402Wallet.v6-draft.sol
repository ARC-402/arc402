...
contract ARC402Wallet is IAccount, ReentrancyGuard {
    ...
    ARC402RegistryV3 public registry;  // NOT immutable — can be updated by owner
        ...
        returns (bytes memory returnData)
    {
        ...
        // Protocol contracts (from ARC402RegistryV3.getContracts()) are auto-allowed.
        ...
        ARC402RegistryV3.ProtocolContracts memory pc = _resolveContracts();
